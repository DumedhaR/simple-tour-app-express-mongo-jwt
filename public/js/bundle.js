parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    zIVT: [
      ...
      { './helpers/bind.js': '4nb4', process: 'rH1J' },
    ],
    '8W9k': [
      function (require, module, exports) {
        'use strict';
    ...
    '8fe9': [
      ...
      { 'base64-js': '5QAn', ieee754: 'O1Qa', isarray: 'fIt4', buffer: '8fe9' },
    ],
    q82J: [
      function (require, module, exports) {
    ...
    RS1v: [
      ...
      { '../utils.js': 'zIVT', '../helpers/AxiosURLSearchParams.js': '/2Bo' },
    ],
    '+GGk': [
      function (require, module, exports) {
        'use strict';
    ...
    os5V: [
      ...
      { '../../../helpers/AxiosURLSearchParams.js': '/2Bo' },
    ],
    bazs: [
      function (require, module, exports) {
        'use strict';
    ...
    O9LF: [
      ...
      { '../utils.js': 'zIVT', '../helpers/parseHeaders.js': '9T8H' },
    ],
    i7gz: [
      function (require, module, exports) {
        'use strict';
    ...
    VMCI: [
      ...
      { '../core/AxiosError.js': '8W9k', '../utils.js': 'zIVT' },
    ],
    wZW9: [
      function (require, module, exports) {
        'use strict';
    ...
    '7LYE': [
      ...
      },
      {
        ...
        '../platform/index.js': 'muVt',
        '../core/AxiosHeaders.js': 'O9LF',
        '../helpers/progressEventReducer.js': '0BAM',
        '../helpers/resolveConfig.js': '8PJ3',
      },
    ],
    bqAq: [
      function (require, module, exports) {
    ...
    lMdc: [
      ...
      { '../env/data.js': 'omJA', '../core/AxiosError.js': '8W9k' },
    ],
    '9RB6': [
      function (require, module, exports) {
        'use strict';
      ...
      },
      {
        ...
        './InterceptorManager.js': '+GGk',
        './dispatchRequest.js': 'U2+V',
        './mergeConfig.js': 'Qj6T',
    ...
    HXpE: [
      ...
      {
        './utils.js': 'zIVT',
        './helpers/bind.js': '4nb4',
        './core/Axios.js': '9RB6',
        './core/mergeConfig.js': 'Qj6T',
        './defaults/index.js': 'M0sG',
        './helpers/formDataToJSON.js': 'K5Tr',
        './cancel/CanceledError.js': 'VMCI',
        './cancel/CancelToken.js': '/VWB',
        './cancel/isCancel.js': 'C9l1',
        './env/data.js': 'omJA',
        './helpers/toFormData.js': 'q82J',
        './core/AxiosError.js': '8W9k',
                          ...
                          if ((i || (o = 'next'), (r = u[o]))) {
                            ...
                            1 === i && (r = u.return) && r.call(u),
                              i < 2 &&
                                ...
                                (i = 1));
                          u = t;
                        } else if ((r = (l = p.n < 0) ? a : n.call(e, p)) !== c)
                          break;
                      } catch (r) {
                        (u = t), (i = 1), (a = r);
                      } finally {
                        ...
                        case 0:
                          return (
                            ...
                            (0, t.default)({
                              ...
                              data: { email: o, password: u },
                            })
                          );
                        case 2:
                          'success' === n.v.data.status &&
                            ((0, r.showAlert)(
                              'success',
                  ...
                  function (n) {
                    for (;;)
                      switch (n.n) {
                        ...
                        case 1:
                          (n.v.data.status = 'success') && location.reload(!0),
                            (n.n = 3);
                          break;
                        case 2:
                          (n.p = 2),
    ...
    FxPS: [
      function (require, module, exports) {
        ...
        function n() {
                          ...
                          if ((i || (o = 'next'), (r = u[o]))) {
                            ...
                            1 === i && (r = u.return) && r.call(u),
                              i < 2 &&
                                ...
                                (i = 1));
                          u = t;
                        } else if ((r = (p = l.n < 0) ? a : e.call(n, l)) !== c)
                          break;
                      } catch (r) {
                        (u = t), (i = 1), (a = r);
                      } finally {
          ...
          var l = [][u]
              ...
              : (o((r = {}), u, function () {
                ...
                r),
            v = (p.prototype = s.prototype = Object.create(l));
          function d(t) {
            return (
              Object.setPrototypeOf
        ...
        var a = (exports.updateSettings = (function () {
          var e = i(
            n().m(function e(o, u) {
              var i, a;
              return n().w(
                    ...
                    switch (e.n) {
                      case 0:
                        return (
                          ...
                          (e.n = 1),
                          (0, t.default)({ method: 'PATCH', url: i, data: o })
                        );
                      case 1:
                        'success' === e.v.data.status &&
                          (0, r.showAlert)(
                            'success',
                            ''.concat(u, ' updated successfully!'),
                          ),
                          (e.n = 3);
                        break;
                      case 2:
    ...
    Uj2q: [
      function (require, module, exports) {
        ...
        function n() {
          ...
          function c(e, n, i, u) {
            var c = n && n.prototype instanceof f ? n : f,
                          ...
                          if ((u || (o = 'next'), (r = i[o]))) {
                            ...
                            1 === u && (r = i.return) && r.call(i),
                              u < 2 &&
                                ...
                                (u = 1));
                          i = t;
                        } else if ((r = (p = l.n < 0) ? c : e.call(n, l)) !== a)
                          break;
                      } catch (r) {
                        (i = t), (u = 1), (c = r);
                      } finally {
          ...
          function h(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, p)
                : ((t.__proto__ = p), o(t, u, 'GeneratorFunction')),
              (t.prototype = Object.create(v)),
              t
            );
          }
    ...
    Focm: [
      function (require, module, exports) {
        ...
        function u() {
          ...
          function n(s, o, t, u) {
            var n = o && o.prototype instanceof l ? o : l,
                      ...
                      s > 3
                        ...
                        : u[0] <= j &&
                          ((t = s < 2 && j < u[1])
                            ...
                            : j < q &&
                              (t = s < 3 || u[0] > o || o > q) &&
                              ((u[4] = s), (u[5] = o), (m.n = q), (i = 0)));
                    }
                    if (t || s > 1) return c;
                    throw ((d = !0), o);
                  }
                  return function (t, a, q) {
                          ...
                          if ((i || (t = 'next'), (r = u[t]))) {
                            ...
                            1 === i && (r = u.return) && r.call(u),
                              i < 2 &&
                                ...
                                (i = 1));
                          u = e;
                        } else if ((r = (d = m.n < 0) ? n : s.call(o, m)) !== c)
                          break;
                      } catch (r) {
                        (u = e), (i = 1), (n = r);
                      } finally {
          ...
          var m = [][o]
              ...
              : (i((r = {}), o, function () {
                ...
                r),
            j = (d.prototype = l.prototype = Object.create(m));
          function q(e) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(e, d)
                : ((e.__proto__ = d), i(e, t, 'GeneratorFunction')),
        ...
        var l = document.getElementById('map'),
          ...
          d = document.querySelector('.nav__el--logout'),
          m = document.querySelector('.form-user-data'),
          j = document.querySelector('.form-user-password'),
          q = document.getElementById('book-tour');
        if (l) {
          var p = JSON.parse(l.dataset.locations);
          (0, r.displayMap)(p);
        }
        a &&
          a.addEventListener('submit', function (r) {
            r.preventDefault();
            var s = document.getElementById('email').value,
              o = document.getElementById('password').value;
            (0, e.login)(s, o);
          }),
          d && d.addEventListener('click', e.logout),
          m &&
        ...
        var f = document.querySelector('body').dataset.alert;
        f && (0, t.showAlert)('success', f, 20);
      },
      {
